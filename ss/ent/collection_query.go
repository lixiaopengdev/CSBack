...
func (cq *CollectionQuery) QueryOwner() *UserQuery {
...
func (cq *CollectionQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *CollectionQuery) FirstIDX(ctx context.Context) uint64 {
...
func (cq *CollectionQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (cq *CollectionQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (cq *CollectionQuery) IDs(ctx context.Context) ([]uint64, error) {
	var ids []uint64
...
func (cq *CollectionQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := cq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (cq *CollectionQuery) WithOwner(opts ...func(*UserQuery)) *CollectionQuery {
	query := &UserQuery{config: cq.config}
...
func (cq *CollectionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Collection, error) {
	...
	if query := cq.withOwner; query != nil {
		if err := cq.loadOwner(ctx, query, nodes, nil,
			func(n *Collection, e *User) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *CollectionQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Collection, init func(*Collection), assign func(*Collection, *User)) error {
...
func (cgb *CollectionGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (cs *CollectionSelect) sqlScan(ctx context.Context, v any) error {
