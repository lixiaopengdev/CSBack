...
func ID(id uint64) predicate.Rule {
...
func IDEQ(id uint64) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint64) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
...
func IDIn(ids ...uint64) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDNotIn(ids ...uint64) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
		v := make([]any, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id uint64) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
...
func IDGTE(id uint64) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
...
func IDLT(id uint64) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
...
func IDLTE(id uint64) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
...
func HasUsed() predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(UsedTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, UsedTable, UsedPrimaryKey...),
		)
...
func HasUsedWith(preds ...predicate.Card) predicate.Rule {
	return predicate.Rule(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
